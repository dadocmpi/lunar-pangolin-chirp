...
<div class="wrap">
  ...
  <div class="body">
    ...
    <p class="text">Thank you for joining Braxel Markets. Your account has been successfully created with the email: <strong>${
      escapeHtml(email)
    }</strong></p>
...
<div class="wrap">
  ...
  <div class="body">
    <div class="alert">
      ...
      ${
      reason
        ? `<p style="margin:10px 0 0;font-size:14px"><strong>Reason:</strong> ${
          escapeHtml(reason)
        }</p>`
        : ""
    }
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <div class="title">Congratulations, ${escapeHtml(name)}!</div>
    <p class="text">Your payment has been successfully processed and your ${
      escapeHtml(plan)
    } infrastructure is now being deployed.</p>
    <div class="details">
...
serve(async (req) => {
  ...
  try {
    ...
    const fromEmail = payload.from ||
      "Braxel Markets <noreply@braxelmarkets.com>";
