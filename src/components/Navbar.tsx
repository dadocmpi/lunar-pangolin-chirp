      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-white font-bold text-xl group-hover:bg-sky-600 transition-colors">
              B
            </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link to="/register">
              <Button className="bg-slate-900 hover:bg-sky-600 text-white rounded-full px-6">
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 p-6 flex flex-col gap-4 shadow-xl animate-in slide-in-from-top duration-300">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/register" onClick={() => setIsOpen(false)}>
              <Button className="w-full justify-center bg-slate-900 hover:bg-sky-600">
                Começar
              </Button>
            </Link>
          </div>
