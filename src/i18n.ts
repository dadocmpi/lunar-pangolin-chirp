...
const enTranslation = {
  ...
  about: { badge: "ABOUT US", title: "INSTITUTIONAL", subtitle: "EXCELLENCE", desc: "Braxel Markets represents the pinnacle of algorithmic capital management.", historyTitle: "OUR HISTORY", historyDesc1: "Founded by a team of quantitative analysts and software engineers, Braxel was built to bridge the gap between retail capital and institutional technology.", historyDesc2: "Today, we focus on risk-adjusted returns and infrastructure stability, providing cutting-edge algorithmic strategies for the modern investor.", stats: { founded: "Founded", users: "Active Users", uptime: "Uptime", support: "Support" }, values: { mission: "MISSION", missionDesc: "To provide elite algorithmic infrastructure for global capital.", vision: "VISION", visionDesc: "To define the future of automated quantitative management.", values: "VALUES", valuesDesc: "Transparency, precision, and unwavering security." }, teamTitle: "LEADERSHIP TEAM", teamDesc: "Meet the founders and managers behind Braxel Markets.", team: [{ name: "[Founder Name]", role: "Co-Founder & CEO", bio: "Quantitative analyst with 10+ years in algorithmic trading and financial engineering.", linkedin: "#" }, { name: "[Founder Name]", role: "Co-Founder & CTO", bio: "Software engineer specialized in high-frequency systems and distributed computing.", linkedin: "#" }, { name: "[Manager Name]", role: "Head of Risk Management", bio: "Former institutional risk analyst with deep expertise in portfolio optimization.", linkedin: "#" }] },
