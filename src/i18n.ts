...
const ptTranslation = {
  ...
  contact: { badge: "SUPORTE", title: "CANAIS", subtitle: "INSTITUCIONAIS", desc: "Nossa equipe de suporte dedicada está disponível 24/7 para consultas institucionais.", infoTitle: "INFORMAÇÕES DE CONTATO", formTitle: "CONSULTA DIRETA", formDesc: "Clique no botão abaixo para abrir seu cliente de e-mail e enviar uma mensagem diretamente.", sendBtn: "ENVIAR E-MAIL", supportHours: "Horário de Suporte", institutionalSupport: "Suporte Institucional 24/7", securityChallenge: "Desafio de Segurança", securityAnswer: "Resposta", incorrectAnswer: "Resposta de segurança incorreta. Por favor, tente novamente.", waitMessage: "Por favor, aguarde um momento antes de enviar outra mensagem.", messageSent: "Mensagem enviada com sucesso! Nossa equipe entrará em contato em breve.", messageFailed: "Falha ao enviar mensagem. Por favor, tente novamente ou envie um e-mail diretamente para marketsbraxel@ouvidor.net", cooldown: "AGUARDE" },
