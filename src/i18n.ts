...
const enTranslation = {
  ...
  contactEmail: { newSubmission: "New Contact Form Submission", name: "Name", email: "Email", subject: "Subject", message: "Message", sentFrom: "Sent from" },
...
const ptTranslation = {
  ...
  contactEmail: { newSubmission: "Nova mensagem do formulário de contato", name: "Nome", email: "E-mail", subject: "Assunto", message: "Mensagem", sentFrom: "Enviado de" },
...
const frTranslation = {
  ...
  contact: { badge: "SUPPORT", title: "CANAUX", subtitle: "INSTITUTIONNELS", desc: "Notre équipe de support dédiée est disponible 24/7 pour les demandes institutionnelles.", infoTitle: "CONTACT", formTitle: "DEMANDE DIRECTE", formDesc: "Cliquez sur le bouton ci-dessous pour ouvrir votre client email et nous envoyer un message directement.", sendBtn: "ENVOYER EMAIL", supportHours: "Heures de Support", institutionalSupport: "Support Institutionnel 24/7", securityChallenge: "Défi de Sécurité", securityAnswer: "Réponse", incorrectAnswer: "Réponse de sécurité incorrecte. Veuillez réessayer.", waitMessage: "Veuillez patienter un moment avant d'envoyer un autre message.", messageSent: "Message envoyé avec succès! Notre équipe vous contactera bientôt.", messageFailed: "Échec de l'envoi du message. Veuillez réessayer ou nous envoyer un email directement à marketsbraxel@ouvidor.net", cooldown: "ATTENDEZ" },
...
const arTranslation = {
  ...
  contact: { badge: "الدعم", title: "القنوات", subtitle: "المؤسسية", desc: "فريق الدعم المتخصص لدينا متاح على مدار الساعة للاستفسارات المؤسسية.", infoTitle: "معلومات الاتصال", formTitle: "استفسار مباشر", formDesc: "انقر على الزر أدناه لفتح برنامج البريد الإلكتروني وإرسال رسالة مباشرة إلينا.", sendBtn: "إرسال البريد", supportHours: "ساعات الدعم", institutionalSupport: "دعم مؤسسي 24/7", securityChallenge: "تحدي الأمان", securityAnswer: "الإجابة", incorrectAnswer: "إجابة الأمان غير صحيحة. يرجى المحاولة مرة أخرى.", waitMessage: "يرجى الانتظار لحظة قبل إرسال رسالة أخرى.", messageSent: "تم إرسال الرسالة بنجاح! سيتواصل معك فريقنا قريبًا.", messageFailed: "فشل إرسال الرسالة. يرجى المحاولة مرة أخرى أو مراسلتنا مباشرة على marketsbraxel@ouvidor.net", cooldown: "الرجاء الانتظار" },
