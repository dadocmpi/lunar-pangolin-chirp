...
const enTranslation = {
  ...
  nav: { pricing: "INVESTMENT PLANS", howItWorks: "INFRASTRUCTURE", about: "ABOUT US", contact: "INSTITUTIONAL SUPPORT", login: "TERMINAL ACCESS", support: "Support", openAccount: "CREATE ACCOUNT", dashboard: "DASHBOARD", logout: "LOGOUT", selectLanguage: "Select Language" },
  footer: { desc: "Institutional-grade investment infrastructure. Proprietary technology for the modern market.", platform: "Platform", company: "Company", support: "Digital Support", rights: "All rights reserved.", privacy: "Privacy", terms: "Terms", disclaimer: "Financial Disclaimer", address: "Business Address", addressValue: "Calle de la Haya, 28935, Parque Coimbra, Madrid, Spain", riskTitle: "RISK WARNING", riskText: "Trading in financial markets involves a substantial risk of loss and is not suitable for all investors. Past performance is not indicative of future results. The value of investments may go down as well as up. Do not invest money you cannot afford to lose. Braxel Markets does not guarantee specific returns." },
  chatbot: { title: "Braxel Support", placeholder: "Type a message...", emailSupport: "Email:" },
  auth: { loginTitle: "Sign In", loginSubtitle: "Enter your access credentials.", registerTitle: "Create Account", registerSubtitle: "Start your journey in the institutional market.", email: "Email Address", password: "Password", fullName: "Full Name", forgotPassword: "Forgot password?", noAccount: "Don't have an account?", hasAccount: "Already have access?", btnAccess: "ACCESS ACCOUNT", btnCreate: "CREATE MY ACCOUNT", termsAgree: "I agree to the Terms and Privacy Policy.", futureTitle: "The Future of", futureSubtitle: "Investments", features: ["Institutional-grade algorithms", "Advanced capital protection", "Millisecond execution", "Full transparency"], accessBadge: "Institutional Access", emailPlaceholder: "Enter your email", fullNamePlaceholder: "Enter your full name", futureSubtitle: "Investments", hasAccount: "Already have an account?", loginLink: "Sign In", loginSideDescription: "Access your institutional terminal.", loginSideFooter: "Institutional-grade security", loginErrorMessage: "Invalid credentials. Please try again.", registerErrorMessage: "Registration failed. Please try again.", registerSuccessMessage: "Account created successfully!", registerSideFooter: "Protected by institutional security", welcomeBackTitle: "Welcome Back", welcomeBackHighlight: "Institutional Terminal", accountNotFound: "Account not found. Please create an account first.", rememberMe: "Remember me", registerLink: "Create account", accountNotFound: "Account not found. Please create an account first.", passwordPlaceholder: "Password", accountNotFoundError: "Account not found. Please create an account first." },
  ...
  about: { badge: "ABOUT US", title: "INSTITUTIONAL", subtitle: "EXCELLENCE", desc: "Braxel Markets represents the pinnacle of algorithmic capital management.", historyTitle: "OUR HISTORY", historyDesc1: "Founded by a team of quantitative analysts and software engineers, Braxel was built to bridge the gap between retail capital and institutional technology.", historyDesc2: "Today, we focus on risk-adjusted returns and infrastructure stability, providing cutting-edge algorithmic strategies for the modern investor.", stats: { founded: "Founded", users: "Active Users", uptime: "Uptime", support: "Support" }, values: { mission: "MISSION", missionDesc: "To provide elite algorithmic infrastructure for global capital.", vision: "VISION", visionDesc: "To define the future of automated quantitative management.", values: "VALUES", valuesDesc: "Transparency, precision, and unwavering security." }, teamTitle: "LEADERSHIP TEAM", teamDesc: "Meet the founders and managers behind Braxel Markets.", team: [{ name: "Bernardo Campi", role: "Founder & CEO", bio: "Quantitative strategist and entrepreneur leading Braxel Markets' vision for institutional-grade algorithmic infrastructure.", photo: "/team-bernardo-campi.jpg" }, { name: "[Co-Founder Name]", role: "Co-Founder & CTO", bio: "Software engineer specialized in high-frequency systems and distributed computing.", photo: "" }, { name: "[Manager Name]", role: "Head of Risk Management", bio: "Former institutional risk analyst with deep expertise in portfolio optimization.", photo: "" }] },
  contact: { badge: "SUPPORT", title: "INSTITUTIONAL", subtitle: "CHANNELS", desc: "Our dedicated support team is available 24/7 for institutional inquiries.", infoTitle: "CONTACT INFO", formTitle: "DIRECT INQUIRY", placeholders: { name: "FULL NAME", email: "EMAIL ADDRESS", subject: "SUBJECT", message: "MESSAGE" }, sendBtn: "SEND INQUIRY", supportHours: "Support Hours", institutionalSupport: "24/7 Institutional Support", securityChallenge: "Security Challenge", securityAnswer: "Answer", incorrectAnswer: "Incorrect security answer. Please try again.", waitMessage: "Please wait a moment before sending another message.", messageSent: "Message sent successfully! Our team will contact you soon.", messageFailed: "Failed to send message. Please try again or email us directly at marketsbraxel@ouvidor.net", cooldown: "PLEASE WAIT" },
  ...
  dashboard: { portfolio: "Investment Portfolio", activeServices: "Active Services", newAllocation: "New Allocation", noServices: "No active investment plans found.", balance: "Current Balance", withdraw: "Withdraw", liquidity: "Liquidity", requestWithdraw: "Request Withdrawal", selectAccount: "Select Account", amount: "Amount (USD)", iban: "IBAN / Bank Details", btnWithdraw: "Submit Withdrawal Request", profile: "Profile Management", settings: "Settings", firstName: "First Name", lastName: "Last Name", saveChanges: "Save Changes", verifiedAccount: "Verified Account", totalAUM: "Total Assets Under Management", activeAlgos: "Active Algorithms", systemStatus: "System Status", operational: "Operational", infraProtection: "Infrastructure Protection", twoFactor: "Two-Factor Authentication", notEnabled: "Not Enabled", enable2FA: "Enable 2FA", kycStatus: "KYC Verification", verified: "Verified", viewDocs: "View Documents", investor: "Investor", kycRequired: "KYC Verification Required", kycRequiredDesc: "Complete identity verification to access all platform features. This is mandatory for all capital management accounts.", kycUnderReview: "KYC Under Review", kycUnderReviewDesc: "Your documents are being reviewed by our compliance team. This typically takes 24-48 hours.", kycRejected: "KYC Verification Rejected", kycRejectedDesc: "Your documents were not accepted. Please resubmit with valid documentation.", resubmitDocs: "Resubmit Documents", completeVerification: "Complete Verification", verificationRequired: "Verification Required", goToVerification: "Go to Verification", totalProfit: "Total Profit", drawdown: "Drawdown", maxDrawdown: "Maximum Drawdown", assetsInOperation: "Assets in Operation", monthlyReturns: "Monthly Returns", analytics: "Analytics", newWithdrawalRequest: "New Withdrawal Request", walletIban: "Wallet / IBAN", network: "Network", transactionHistory: "Transaction History", operations: "Operations", asset: "Asset", type: "Type", entry: "Entry", exit: "Exit", profit: "Profit", time: "Time", status: "Status", open: "Open", closed: "Closed", withdrawalAmountPlaceholder: "0.00", withdrawalWalletPlaceholder: "Crypto wallet address or IBAN", newEmailPlaceholder: "new@email.com", verificationCodePlaceholder: "Enter 6-digit code", minPasswordPlaceholder: "Minimum 8 characters", confirmPasswordPlaceholder: "Re-enter new password", accountNotFound: "Account not found. Please create an account first.", loginSuccess: "Login successful!", rememberMe: "Remember me", withdrawalAmountPlaceholder: "0.00", withdrawalWalletPlaceholder: "Crypto wallet address or IBAN", newEmailPlaceholder: "new@email.com", verificationCodePlaceholder: "Enter 6-digit code", minPasswordPlaceholder: "Minimum 8 characters", confirmPasswordPlaceholder: "Re-enter new password", newEmailLabel: "New Email Address", sendConfirmationLink: "Send Confirmation Link", withdrawalAmountPlaceholder: "0.00", withdrawalWalletPlaceholder: "Crypto wallet address or IBAN", newEmailPlaceholder: "new@email.com", verificationCodePlaceholder: "Enter 6-digit code", minPasswordPlaceholder: "Minimum 8 characters", confirmPasswordPlaceholder: "Re-enter new password", identityVerified: "Your identity has been verified! All features are now unlocked.", verificationRejected: "Your verification was rejected. Please resubmit your documents.", profileUpdated: "Profile updated successfully.", failedUpdateProfile: "Failed to update profile.", differentEmail: "Please enter a different email address.", confirmationLinkSent: "A confirmation link has been sent to the new email address. Please verify to complete the change.", failedEmail: "Failed to update email.", passwordsDoNotMatch: "Passwords do not match.", passwordTooShort: "Password must be at least 8 characters.", passwordChanged: "Password changed successfully.", failedPassword: "Failed to change password.", uploadDocument: "Please upload a document.", completeSteps: "Please complete all verification steps.", documentsSubmitted: "Documents submitted for verification. You will be notified once reviewed.", failedDocuments: "Failed to submit documents." },
  checkout: { summary: "SUMMARY", allocationTitle: "ALLOCATION", allocationSubtitle: "INSTITUTIONAL", tierLabel: "Algorithmic Infrastructure Tier", billedMonthly: "Billed Monthly", detailsTitle: "Allocation Details", managedCapital: "Managed Capital", setupFee: "Setup Fee", waived: "WAIVED", latency: "Execution Latency", infrastructureTitle: "Infrastructure Included", realTimeMonitoring: "Real-Time Monitoring", activeUponDeployment: "Active upon deployment", totalDue: "Total Due", dedicatedNode: "Dedicated Node", globalMarkets: "Global Markets", instantSetup: "Instant Setup", authRequired: "AUTHENTICATION REQUIRED", authDesc: "Please sign in or create an account to proceed with the allocation.", btnLogin: "SIGN IN TO CONTINUE", btnRegister: "CREATE ACCOUNT", confirmDeployment: "Confirm Deployment", deploymentDesc: "By confirming, you authorize the deployment of the algorithmic infrastructure associated with the {{plan}} plan.", proceedPayment: "PROCEED TO SECURE PAYMENT", secureGateway: "Secure Gateway", back: "Back", riskDisclosure: "Risk Disclosure: Algorithmic trading involves significant risk of loss. Past performance is not indicative of future results.", secureTransaction: "Secure Transaction", paypalNote: "Your payment details are securely processed by PayPal. Braxel Markets does not store your card details.", encryptionNote: "Encrypted with Institutional AES-256 Standards", verifying: "Verifying Institutional Transaction...", loading: "Loading Terminal...", globalInfra: "Global Payment Infrastructure", qrCode: "QR Code", allCards: "All Cards", selectPaymentMethod: "Select Payment Method", choosePayment: "Choose how you want to pay", creditCard: "Credit Card", instantPayment: "Instant Payment", cardDesc: "Visa, Mastercard and other cards", crypto: "Cryptocurrency", cryptoLabel: "USDT, BTC, ETH", cryptoDesc: "Fast and secure crypto transfer", wiseTransfer: "Bank Transfer", wiseInternational: "International Wire", wiseDesc: "Transfer directly to our bank account via Wise", anyCountry: "Any Country", lowFees: "Low Fees", transferInstructions: "Transfer Instructions", wiseStep1: "Copy the bank details below", wiseStep2: "Make a transfer from your bank or Wise account", wiseStep3: "Click confirm after making the transfer", bankDetails: "Bank Details", accountHolder: "Account Holder", bankName: "Bank Name", routingNumber: "Routing Number", accountNumber: "Account Number", bankAddress: "Bank Address", amountToSend: "Amount to Send", paymentReference: "Include your email as payment reference", wiseNote: "After making the transfer, click confirm below. Your account will be activated after verification (1-3 business days).", wiseConfirmText: "I have made the bank transfer and confirm that the amount sent matches the plan price.", wiseConfirmRequired: "Please confirm you made the transfer", wisePaymentSuccess: "Payment confirmed! Your account is being set up.", confirmWise: "CONFIRM TRANSFER", openWise: "Open Wise Website", securePayment: "Secure Payment", cardNumber: "Card Number", cardName: "Name on Card", cardExpiry: "Expiry", payNow: "PAY NOW", amountToPay: "Amount to Pay", selectNetwork: "Select Network", yourAddress: "Your Address", yourAddressPlaceholder: "Enter your USDT address", important: "IMPORTANT", cryptoNote: "Send the exact amount to receive the plan", confirmCrypto: "CONFIRM WITH CRYPTO", copied: "Copied!", cryptoPending: "Payment recorded! Awaiting confirmation.", processing: "Processing...", paymentSuccess: "Payment approved!", selectCountry: "Select Country", searchCountry: "Search country...", phone: "Phone Number", fillAllFields: "Fill all fields", noKyc: "KYC Required", phonePlaceholder: "999999999", cardNumberPlaceholder: "0000 0000 0000 0000", cardNamePlaceholder: "JOAO SILVA", cardExpiryPlaceholder: "MM/YY", cvvPlaceholder: "123", cvvLabel: "CVC", paymentFailed: "Payment failed", paymentError: "Payment error" }
};
...
const ptTranslation = {
  ...
  auth: { loginTitle: "Entrar", loginSubtitle: "Insira suas credenciais de acesso.", registerTitle: "Criar Conta", registerSubtitle: "Comece sua jornada no mercado institucional.", email: "Endereço de E-mail", password: "Senha", fullName: "Nome Completo", forgotPassword: "Esqueceu a senha?", noAccount: "Não tem uma conta?", hasAccount: "Já tem acesso?", btnAccess: "ACESSAR CONTA", btnCreate: "CRIAR MINHA CONTA", termsAgree: "Aceito os Termos e a Privacidade.", futureTitle: "O Futuro dos", futureSubtitle: "Investimentos", features: ["Algoritmos de nível institucional", "Proteção avançada de capital", "Execução em milissegundos", "Transparência total"], accessBadge: "Acesso Institucional", emailPlaceholder: "Digite seu e-mail", fullNamePlaceholder: "Digite seu nome completo", loginLink: "Entrar", loginSideDescription: "Acesse seu terminal institucional.", loginSideFooter: "Segurança de nível institucional", loginErrorMessage: "Credenciais inválidas. Por favor, tente novamente.", registerErrorMessage: "Falha no registro. Por favor, tente novamente.", registerSuccessMessage: "Conta criada com sucesso!", registerSideFooter: "Protegido por segurança institucional", welcomeBackTitle: "Bem-vindo de Volta", welcomeBackHighlight: "Terminal Institucional", accountNotFound: "Conta não encontrada. Por favor, crie uma conta primeiro.", rememberMe: "Lembrar-me", registerLink: "Criar conta", passwordPlaceholder: "Senha" },
  hero: { title1: "GESTÃO ALGORÍTMICA", title2: "DE CAPITAL DE ELITE", desc: "Implemente estratégias quantitativas de nível institucional projetadas para o mercado moderno. Experimente precisão de execução em milissegundos e protocolos avançados de mitigação de riscos.", getStarted: "EXPLORAR PLANOS DE INVESTIMENTO", viewStrategies: "METODOLOGIA TÉCNICA" },
  stats: { volume: "Gestão Estratégica de Capital", traders: "Contas Ativas", uptime: "Tempo de Atividade da Infraestrutura", latency: "Precisão de Execução" },
  methodology: { badge: "METODOLOGIA", title: "MODELOS QUANTITATIVOS", statArb: { title: "ARBITRAGEM ESTATÍSTICA", desc: "Exploração de ineficiências temporárias de preço entre ativos correlacionados usando modelos de cointegração e negociação em pares.", f1: "Análise de Cointegração", f2: "Algoritmos de Seleção de Pares", f3: "Limiar Z-Score" }, meanRev: { title: "REVERSÃO À MÉDIA", desc: "Identificação de desvios de preço de ativos em relação às médias históricas, com regras sistemáticas de entrada e saída.", f1: "Sinais de Bandas de Bollinger", f2: "Detecção de Divergência RSI", f3: "Modelos Ornstein-Uhlenbeck" }, hft: { title: "NEGOCIAÇÃO DE ALTA FREQUÊNCIA", desc: "Estratégias de execução de latência ultra-baixa com infraestrutura co-localizada para ordens em nível de microssegundos.", f1: "Microestrutura de Mercado", f2: "Análise de Fluxo de Ordens", f3: "Arbitragem de Latência" } },
  transparency: { badge: "INFRAESTRUTURA", title: "TECNOLOGIA TRANSPARENTE", desc: "Nossa infraestrutura é construída sobre bases de nível empresarial, garantindo confiabilidade, velocidade e segurança.", connectivity: { title: "CONECTIVIDADE", desc: "Acesso direto ao mercado através de data centers Equinix (NY5, LD4, TY3) com conectividade sub-milissegundo para as principais bolsas." }, cloud: { title: "EXECUÇÃO EM NUVEM", desc: "Motores de execução redundantes implantados em AWS (us-east-1, eu-west-1) e Azure para resiliência de failover." }, security: { title: "SEGURANÇA", desc: "Criptografia de ponta a ponta, conformidade SOC 2 Tipo II e autenticação multicamada para todas as operações dos clientes." } },
  process_home: { badge: "PROCESSO", title: "FLUXO", subtitle: "INSTITUCIONAL", step1: { title: "REGISTRO", desc: "Integração segura e verificação de identidade." }, step2: { title: "ALOCAÇÃO", desc: "Seleção do nível de capital gerenciado." }, step3: { title: "INTEGRAÇÃO", desc: "Implantação da infraestrutura algorítmica." }, step4: { title: "MONITORAMENTO", desc: "Acompanhamento de desempenho em tempo real via terminal." }, step5: { title: "LIQUIDEZ", desc: "Protocolos simplificados de saque de lucros." } },
  ...
  pricing: { badge: "TRANSPARÊNCIA", title: "ALOCAÇÃO", subtitle: "DE CAPITAL", desc: "Infraestrutura de nível institucional com uma estrutura de taxas transparente.", select: "GARANTIR ESTE PLANO", allocation: "CAPITAL GERENCIADO", month: "taxa mensal" },
  plans: {
    starter: "STARTER 5K",
    starterFeatures: "Automação, Gestão de Conta, Suporte por Email, Risco Controlado",
    pro: "PRO 10K",
    proFeatures: "Recursos Starter, Suporte Prioritário, Logs Detalhados",
    advanced: "AVANÇADO 25K",
  ...
  about: { badge: "SOBRE NÓS", title: "EXCELÊNCIA", subtitle: "INSTITUCIONAL", desc: "Braxel Markets representa o auge da gestão algorítmica de capital.", historyTitle: "NOSSA HISTÓRIA", historyDesc1: "Fundada por uma equipe de analistas quantitativos e engenheiros de software, a Braxel foi criada para preencher a lacuna entre capital de varejo e tecnologia institucional.", historyDesc2: "Hoje, nos concentramos em retornos ajustados ao risco e estabilidade da infraestrutura, fornecendo estratégias algorítmicas de ponta para o investidor moderno.", stats: { founded: "Fundada", users: "Usuários Ativos", uptime: "Tempo de Atividade", support: "Suporte" }, values: { mission: "MISSÃO", missionDesc: "Fornecer infraestrutura algorítmica de elite para capital global.", vision: "VISÃO", visionDesc: "Definir o futuro da gestão quantitativa automatizada.", values: "VALORES", valuesDesc: "Transparência, precisão e segurança inabalável." }, teamTitle: "EQUIPE DE LIDERANÇA", teamDesc: "Conheça os fundadores e gestores por trás da Braxel Markets.", team: [{ name: "Bernardo Campi", role: "Fundador & CEO", bio: "Estrategista quantitativo e empreendedor liderando a visão da Braxel Markets para infraestrutura algorítmica institucional.", photo: "/team-bernardo-campi.jpg" }, { name: "[Nome do Cofundador]", role: "Cofundador & CTO", bio: "Engenheiro de software especializado em sistemas de alta frequência e computação distribuída.", photo: "" }, { name: "[Nome do Gestor]", role: "Diretor de Gestão de Riscos", bio: "Ex-analista de riscos institucionais com ampla experiência em otimização de portfólio.", photo: "" }] },
  contact: { badge: "SUPORTE", title: "CANAIS", subtitle: "INSTITUCIONAIS", desc: "Nossa equipe de suporte dedicada está disponível 24/7 para consultas institucionais.", infoTitle: "INFORMAÇÕES DE CONTATO", formTitle: "CONSULTA DIRETA", placeholders: { name: "NOME COMPLETO", email: "ENDEREÇO DE E-MAIL", subject: "ASSUNTO", message: "MENSAGEM" }, sendBtn: "ENVIAR CONSULTA", supportHours: "Horário de Suporte", institutionalSupport: "Suporte Institucional 24/7", securityChallenge: "Desafio de Segurança", securityAnswer: "Resposta", incorrectAnswer: "Resposta de segurança incorreta. Por favor, tente novamente.", waitMessage: "Por favor, aguarde um momento antes de enviar outra mensagem.", messageSent: "Mensagem enviada com sucesso! Nossa equipe entrará em contato em breve.", messageFailed: "Falha ao enviar mensagem. Por favor, tente novamente ou envie um e-mail diretamente para marketsbraxel@ouvidor.net", cooldown: "AGUARDE" },
  dashboard: { portfolio: "Portfólio", activeServices: "Serviços Ativos", newAllocation: "Nova Alocação", noServices: "Nenhum plano de investimento ativo encontrado.", balance: "Saldo Atual", withdraw: "Saque", liquidity: "Liquidez", requestWithdraw: "Solicitar Saque", selectAccount: "Selecionar Conta", amount: "Valor (USD)", iban: "IBAN / Dados Bancários", btnWithdraw: "Enviar Solicitação de Saque", profile: "Gerenciamento de Perfil", settings: "Configurações", firstName: "Nome", lastName: "Sobrenome", saveChanges: "SALVAR ALTERAÇÕES", verifiedAccount: "Conta Verificada", totalAUM: "Total de Ativos Gerenciados", activeAlgos: "Algoritmos Ativos", systemStatus: "Status do Sistema", operational: "Operacional", infraProtection: "Proteção de Infraestrutura", twoFactor: "Autenticação de Dois Fatores", notEnabled: "Não Ativado", enable2FA: "Ativar 2FA", kycStatus: "Verificação KYC", verified: "Verificado", viewDocs: "Ver Documentos", investor: "Investidor", kycRequired: "Verificação KYC Necessária", kycRequiredDesc: "Complete a verificação de identidade para acessar todos os recursos da plataforma. Isto é obrigatório para todas as contas que gerenciam capital.", kycUnderReview: "KYC em Análise", kycUnderReviewDesc: "Seus documentos estão sendo analisados pela nossa equipe de conformidade. Isso geralmente leva de 24 a 48 horas.", kycRejected: "Verificação KYC Recusada", kycRejectedDesc: "Seus documentos não foram aceitos. Por favor, reenvie com documentação válida.", resubmitDocs: "Reenviar Documentos", completeVerification: "Completar Verificação", verificationRequired: "Verificação Necessária", goToVerification: "Ir para Verificação", totalProfit: "Lucro Total", drawdown: "Drawdown", maxDrawdown: "Drawdown Máximo", assetsInOperation: "Ativos em Operação", monthlyReturns: "Retornos Mensais", analytics: "Análises", newWithdrawalRequest: "Nova Solicitação de Saque", walletIban: "Carteira / IBAN", network: "Rede", transactionHistory: "Histórico de Transações", operations: "Operações", asset: "Ativo", type: "Tipo", entry: "Entrada", exit: "Saída", profit: "Lucro", time: "Hora", status: "Status", open: "Aberto", closed: "Fechado", withdrawalAmountPlaceholder: "0.00", withdrawalWalletPlaceholder: "Endereço da carteira cripto ou IBAN", newEmailPlaceholder: "novo@email.com", verificationCodePlaceholder: "Digite o código de 6 dígitos", minPasswordPlaceholder: "Mínimo de 8 caracteres", confirmPasswordPlaceholder: "Digite a senha novamente", accountNotFound: "Conta não encontrada. Por favor, crie uma conta primeiro.", loginSuccess: "Login realizado com sucesso!", rememberMe: "Lembrar-me", identityVerified: "Sua identidade foi verificada! Todos os recursos agora estão desbloqueados.", verificationRejected: "Sua verificação foi recusada. Por favor, reenvie seus documentos.", profileUpdated: "Perfil atualizado com sucesso.", failedUpdateProfile: "Falha ao atualizar o perfil.", differentEmail: "Por favor, insira um endereço de e-mail diferente.", confirmationLinkSent: "Um link de confirmação foi enviado para o novo endereço de e-mail. Por favor, verifique para concluir a alteração.", failedEmail: "Falha ao atualizar o e-mail.", passwordsDoNotMatch: "As senhas não coincidem.", passwordTooShort: "A senha deve ter pelo menos 8 caracteres.", passwordChanged: "Senha alterada com sucesso.", failedPassword: "Falha ao alterar a senha.", uploadDocument: "Por favor, envie um documento.", completeSteps: "Por favor, conclua todas as etapas de verificação.", documentsSubmitted: "Documentos enviados para verificação. Você será notificado quando forem analisados.", failedDocuments: "Falha ao enviar os documentos.", newEmailLabel: "Novo Endereço de E-mail", sendConfirmationLink: "Enviar Link de Confirmação" },
  checkout: { summary: "RESUMO", allocationTitle: "ALOCAÇÃO", allocationSubtitle: "INSTITUCIONAL", tierLabel: "Nível de Infraestrutura Algorítmica", billedMonthly: "Faturado Mensalmente", detailsTitle: "Detalhes da Alocação", managedCapital: "Capital Gerenciado", setupFee: "Taxa de Configuração", waived: "ISENTA", latency: "Latência de Execução", infrastructureTitle: "Infraestrutura Incluída", realTimeMonitoring: "Monitoramento em Tempo Real", activeUponDeployment: "Ativo após a implantação", totalDue: "Total a Pagar", dedicatedNode: "Nó Dedicado", globalMarkets: "Mercados Globais", instantSetup: "Configuração Instantânea", authRequired: "AUTENTICAÇÃO NECESSÁRIA", authDesc: "Por favor, entre ou crie uma conta para prosseguir com a alocação.", btnLogin: "ENTRAR PARA PROSSEGUIR", btnRegister: "CRIAR CONTA", confirmDeployment: "Confirmar Implantação", deploymentDesc: "Ao confirmar, você autoriza a implantação da infraestrutura algorítmica associada ao plano {{plan}}.", proceedPayment: "PROSSEGUIR PARA PAGAMENTO SEGURO", secureGateway: "Gateway Seguro", back: "Voltar", riskDisclosure: "Divulgação de Risco: A negociação algorítmica envolve risco substancial de perda. Desempenhos passados não são indicativos de resultados futuros.", secureTransaction: "Transação Segura", paypalNote: "Suas informações de pagamento são processadas com segurança pelo PayPal. Braxel Markets não armazena os dados do seu cartão.", encryptionNote: "Criptografado com Padrões Institucionais AES-256", verifying: "Verificando Transação Institucional...", loading: "Carregando Terminal...", globalInfra: "Infraestrutura Global de Pagamentos", qrCode: "Código QR", allCards: "Todos os Cartões", selectPaymentMethod: "Selecionar Método de Pagamento", choosePayment: "Escolha como deseja pagar", creditCard: "Cartão de Crédito", instantPayment: "Pagamento Instantâneo", cardDesc: "Visa, Mastercard e outros cartões", crypto: "Criptomoeda", cryptoLabel: "USDT, BTC, ETH", cryptoDesc: "Transferência cripto rápida e segura", wiseTransfer: "Transferência Bancária", wiseInternational: "Transferência Internacional", wiseDesc: "Transfira diretamente para nossa conta bancária via Wise", anyCountry: "Qualquer País", lowFees: "Taxas Baixas", transferInstructions: "Instruções de Transferência", wiseStep1: "Copie os dados bancários abaixo", wiseStep2: "Faça uma transferência do seu banco ou conta Wise", wiseStep3: "Clique em confirmar após fazer a transferência", bankDetails: "Dados Bancários", accountHolder: "Titular da Conta", bankName: "Nome do Banco", routingNumber: "Código do Banco", accountNumber: "Número da Conta", bankAddress: "Endereço do Banco", amountToSend: "Valor a Transferir", paymentReference: "Inclua seu email como referência", wiseNote: "Após fazer a transferência, clique em confirmar abaixo. Sua conta será ativada após verificação (1-3 dias úteis).", wiseConfirmText: "Eu fiz a transferência bancária e confirmo que o valor enviado corresponde ao preço do plano.", wiseConfirmRequired: "Por favor, confirme que fez a transferência", wisePaymentSuccess: "Pagamento confirmado! Sua conta está sendo configurada.", confirmWise: "CONFIRMAR TRANSFERÊNCIA", openWise: "Abrir Site Wise", securePayment: "Pagamento Seguro", cardNumber: "Número do Cartão", cardName: "Nome no Cartão", cardExpiry: "Validade", payNow: "PAGAR AGORA", amountToPay: "Valor a Pagar", selectNetwork: "Selecionar Rede", yourAddress: "Seu Endereço", yourAddressPlaceholder: "Insira seu endereço USDT", important: "IMPORTANTE", cryptoNote: "Envie o valor exato para receber o plano", confirmCrypto: "CONFIRMAR COM CRIPTO", copied: "Copiado!", cryptoPending: "Pagamento registrado! Aguardando confirmação.", processing: "Processando...", paymentSuccess: "Pagamento aprovado!", selectCountry: "Selecionar País", searchCountry: "Buscar país...", phone: "Número de Telefone", fillAllFields: "Preencha todos os campos", phonePlaceholder: "999999999", cardNumberPlaceholder: "0000 0000 0000 0000", cardNamePlaceholder: "NOME COMPLETO", cardExpiryPlaceholder: "MM/AA", cvvPlaceholder: "123", cvvLabel: "CVC", paymentFailed: "Pagamento falhou", paymentError: "Erro no pagamento" },
  ...
  transparency: {
    ...
    protocolDesc: "Nossa infraestrutura segue padrões rigorosos de conformidade e gestão de riscos para garantir o mais alto nível de segurança operacional."
  },
  faq: {
...
const itTranslation = {
  ...
  auth: { loginTitle: "Accesso", loginSubtitle: "Inserisci le tue credenziali di accesso.", registerTitle: "Crea Account", registerSubtitle: "Inizia il tuo percorso nel mercato istituzionale.", email: "Indirizzo E-mail", password: "Password", fullName: "Nome Completo", forgotPassword: "Password dimenticata?", noAccount: "Non hai un account?", hasAccount: "Hai già accesso?", btnAccess: "ACCEDI ALL'ACCOUNT", btnCreate: "CREA IL MIO ACCOUNT", termsAgree: "Accetto i Termini e la Privacy.", futureTitle: "Il Futuro degli", futureSubtitle: "Investimenti", features: ["Algoritmi di livello istituzionale", "Protezione avanzata del capitale", "Esecuzione in millisecondi", "Trasparenza totale"], accessBadge: "Accesso Istituzionale", emailPlaceholder: "Inserisci la tua email", fullNamePlaceholder: "Inserisci il tuo nome completo", loginLink: "Accedi", loginSideDescription: "Accedi al tuo terminale istituzionale.", loginSideFooter: "Sicurezza di livello istituzionale", loginErrorMessage: "Credenziali non valide. Riprova.", registerErrorMessage: "Registrazione fallita. Riprova.", registerSuccessMessage: "Account creato con successo!", registerSideFooter: "Protetto da sicurezza istituzionale", welcomeBackTitle: "Bentornato", welcomeBackHighlight: "Terminale Istituzionale", accountNotFound: "Account non trovato. Crea un account prima.", rememberMe: "Ricordami", registerLink: "Crea account", passwordPlaceholder: "Password" },
  ...
  plans: {
    starter: "STARTER 5K",
    starterFeatures: "Automazione, Gestione Account, Supporto Email, Rischio Controllato",
    pro: "PRO 10K",
    proFeatures: "Funzionalità Starter, Supporto Prioritario, Log Dettagliati",
    advanced: "AVANZATO 25K",
...
const esTranslation = {
  ...
  plans: {
    starter: "STARTER 5K",
    starterFeatures: "Automatización, Gestión de Cuenta, Soporte por Email, Riesgo Controlado",
    pro: "PRO 10K",
    proFeatures: "Características Starter, Soporte Prioritario, Logs Detallados",
    advanced: "AVANZADO 25K",
...
const frTranslation = {
  ...
  auth: { loginTitle: "Connexion", loginSubtitle: "Entrez vos identifiants d'accès.", registerTitle: "Créer un Compte", registerSubtitle: "Commencez votre parcours sur le marché institutionnel.", email: "Adresse E-mail", password: "Mot de Passe", fullName: "Nom Complet", forgotPassword: "Mot de passe oublié ?", noAccount: "Vous n'avez pas de compte ?", hasAccount: "Vous avez déjà accès ?", btnAccess: "ACCÉDER AU COMPTE", btnCreate: "CRÉER MON COMPTE", termsAgree: "J'accepte les Conditions et la Confidentialité.", futureTitle: "L'Avenir de", futureSubtitle: "l'Investissement", features: ["Algorithmes de niveau institutionnel", "Protection avancée du capital", "Exécution en millisecondes", "Transparence totale"], accessBadge: "Accès Institutionnel", emailPlaceholder: "Entrez votre email", fullNamePlaceholder: "Entrez votre nom complet", loginLink: "Connexion", loginSideDescription: "Accédez à votre terminal institutionnel.", loginSideFooter: "Sécurité de niveau institutionnel", loginErrorMessage: "Identifiants invalides. Veuillez réessayer.", registerErrorMessage: "Échec de l'inscription. Veuillez réessayer.", registerSuccessMessage: "Compte créé avec succès !", registerSideFooter: "Protégé par sécurité institutionnelle", welcomeBackTitle: "Bon Retour", welcomeBackHighlight: "Terminal Institutionnel", accountNotFound: "Compte non trouvé. Veuillez créer un compte.", rememberMe: "Se souvenir de moi", registerLink: "Créer un compte", passwordPlaceholder: "Mot de passe" },
  ...
  plans: {
    starter: "STARTER 5K",
    starterFeatures: "Automatisation, Gestion de Compte, Support Email, Risque Contrôlé",
    pro: "PRO 10K",
    proFeatures: "Fonctionnalités Starter, Support Prioritaire, Logs Détaillés",
    advanced: "AVANCÉ 25K",
...
const deTranslation = {
  ...
  auth: { loginTitle: "Anmeldung", loginSubtitle: "Geben Sie Ihre Zugangsdaten ein.", registerTitle: "Konto erstellen", registerSubtitle: "Starten Sie Ihren Weg im institutionellen Markt.", email: "E-Mail-Adresse", password: "Passwort", fullName: "Vollständiger Name", forgotPassword: "Passwort vergessen?", noAccount: "Noch kein Konto?", hasAccount: "Bereits Zugang?", btnAccess: "KONTO ZUGREIFEN", btnCreate: "MEIN KONTO ERSTELLEN", termsAgree: "Ich stimme den AGB und Datenschutzrichtlinien zu.", futureTitle: "Die Zukunft der", futureSubtitle: "Investition", features: ["Institutionelle Algorithmen", "Fortschrittlicher Kapitalschutz", "Ausführung in Millisekunden", "Vollständige Transparenz"], accessBadge: "Institutioneller Zugang", emailPlaceholder: "Geben Sie Ihre E-Mail ein", fullNamePlaceholder: "Geben Sie Ihren vollständigen Namen ein", loginLink: "Anmelden", loginSideDescription: "Zugang zu Ihrem institutionellen Terminal.", loginSideFooter: "Institutionelle Sicherheit", loginErrorMessage: "Ungültige Anmeldedaten. Bitte versuchen Sie es erneut.", registerErrorMessage: "Registrierung fehlgeschlagen. Bitte versuchen Sie es erneut.", registerSuccessMessage: "Konto erfolgreich erstellt!", registerSideFooter: "Geschützt durch institutionelle Sicherheit", welcomeBackTitle: "Willkommen Zurück", welcomeBackHighlight: "Institutionelles Terminal", accountNotFound: "Konto nicht gefunden. Bitte erstellen Sie zuerst ein Konto.", rememberMe: "Angemeldet bleiben", registerLink: "Konto erstellen", passwordPlaceholder: "Passwort" },
  ...
  plans: {
    starter: "STARTER 5K",
    starterFeatures: "Automatisierung, Kontoverwaltung, E-Mail-Support, Kontrolliertes Risiko",
    pro: "PRO 10K",
    proFeatures: "Starter-Funktionen, Prioritäts-Support, Detaillierte Protokolle",
    advanced: "FORTGESCHRITTEN 25K",
...
const ruTranslation = {
  ...
  auth: { loginTitle: "Вход", loginSubtitle: "Введите ваши учётные данные.", registerTitle: "Создать Аккаунт", registerSubtitle: "Начните свой путь на институциональном рынке.", email: "Электронная Почта", password: "Пароль", fullName: "Полное Имя", forgotPassword: "Забыли пароль?", noAccount: "Нет аккаунта?", hasAccount: "Уже есть доступ?", btnAccess: "ВОЙТИ В АККАУНТ", btnCreate: "СОЗДАТЬ АККАУНТ", termsAgree: "Я принимаю Условия и Политику конфиденциальности.", futureTitle: "Будущее", futureSubtitle: "Инвестиций", features: ["Алгоритмы институционального уровня", "Продвинутая защита капитала", "Исполнение в миллисекундах", "Полная прозрачность"], accessBadge: "Институциональный Доступ", emailPlaceholder: "Введите ваш email", fullNamePlaceholder: "Введите ваше полное имя", loginLink: "Войти", loginSideDescription: "Доступ к вашему институциональному терминалу.", loginSideFooter: "Безопасность институционального уровня", loginErrorMessage: "Неверные данные. Пожалуйста, попробуйте снова.", registerErrorMessage: "Ошибка регистрации. Пожалуйста, попробуйте снова.", registerSuccessMessage: "Аккаунт успешно создан!", registerSideFooter: "Защищено институциональной безопасностью", welcomeBackTitle: "С Возвращением", welcomeBackHighlight: "Институциональный Терминал", accountNotFound: "Аккаунт не найден. Пожалуйста, создайте аккаунт.", rememberMe: "Запомнить меня", registerLink: "Создать аккаунт", passwordPlaceholder: "Пароль" },
  ...
  plans: {
    starter: "СТАРТЕР 2K",
    starterFeatures: "Автоматизация, Управление Аккаунтом, Email-поддержка, Контролируемый Риск",
    pro: "ПРО 5K",
    proFeatures: "Функции Стартера, Приоритетная Поддержка, Детальные Логи",
    advanced: "ПРОДВИНУТЫЙ 25K",
  ...
  about: { badge: "О НАС", title: "ИНСТИТУЦИОНАЛЬНОЕ", subtitle: "ПРЕВОСХОДСТВО", desc: "Braxel Markets представляет вершину алгоритмического управления капиталом.", historyTitle: "НАША ИСТОРИЯ", historyDesc1: "Основанная командой количественных аналитиков и программных инженеров, Braxel была создана, чтобы объединить розничный капитал и институциональные технологии.", historyDesc2: "Сегодня мы фокусируемся на доходности с учётом рисков и стабильности инфраструктуры, предоставляя передовые алгоритмические стратегии для современного инвестора.", stats: { founded: "Основана", users: "Активные Пользователи", uptime: "Время Работы", support: "Поддержка" }, values: { mission: "МИССИЯ", missionDesc: "Предоставить элитную алгоритмическую инфраструктуру для глобального капитала.", vision: "ВИДЕНИЕ", visionDesc: "Определить будущее автоматизированного количественного управления.", values: "ЦЕННОСТИ", valuesDesc: "Прозрачность, точность и непоколебимая безопасность." }, teamTitle: "КОМАНДА РУКОВОДСТВА", teamDesc: "Познакомьтесь с основателями и управляющими Braxel Markets.", team: [{ name: "Bernardo Campi", role: "Основатель и CEO", bio: "Количественный стратег и предприниматель, возглавляющий видение Braxel Markets в области институциональной алгоритмической инфраструктуры.", photo: "/team-bernardo-campi.jpg" }, { name: "[Имя Сооснователя]", role: "Сооснователь и CTO", bio: "Программный инженер, специализирующийся на высокочастотных системах и распределённых вычислениях.", photo: "" }, { name: "[Имя Управляющего]", role: "Руководитель Управления Рисками", bio: "Бывший институциональный аналитик рисков с глубокой экспертизой в оптимизации портфеля.", photo: "" }] },
  contact: { badge: "ПОДДЕРЖКА", title: "ИНСТИТУЦИОНАЛЬНЫЕ", subtitle: "КАНАЛЫ", desc: "Наша специализированная команда поддержки доступна 24/7 для институциональных запросов.", infoTitle: "КОНТАКТЫ", formTitle: "ПРЯМОЙ ЗАПРОС", placeholders: { name: "ПОЛНОЕ ИМЯ", email: "ЭЛЕКТРОННАЯ ПОЧТА", subject: "ТЕМА", message: "СООБЩЕНИЕ" }, sendBtn: "ОТПРАВИТЬ ЗАПРОС", supportHours: "Часы Поддержки", institutionalSupport: "24/7 Институциональная Поддержка", securityChallenge: "Проверка Безопасности", securityAnswer: "Ответ", incorrectAnswer: "Неверный ответ безопасности. Пожалуйста, попробуйте снова.", waitMessage: "Пожалуйста, подождите перед отправкой следующего сообщения.", messageSent: "Сообщение успешно отправлено! Наша команда свяжется с вами в ближайшее время.", messageFailed: "Не удалось отправить сообщение. Пожалуйста, попробуйте снова или отправьте нам письмо напрямую на marketsbraxel@ouvidor.net", cooldown: "ПОДОЖДИТЕ" },
  ...
  checkout: { summary: "ИТОГО", allocationTitle: "Институциональная", allocationSubtitle: "Аллокация", tierLabel: "Уровень Алгоритмической Инфраструктуры", billedMonthly: "Ежемесячная Оплата", detailsTitle: "Детали Аллокации", managedCapital: "Управляемый Капитал", setupFee: "Плата за Настройку", waived: "ОТМЕНЕНА", latency: "Задержка Исполнения", infrastructureTitle: "Включённая Инфраструктура", realTimeMonitoring: "Мониторинг в Реальном Времени", activeUponDeployment: "Активно после развёртывания", totalDue: "Итого к Оплате", dedicatedNode: "Выделенный Узел", globalMarkets: "Глобальные Рынки", instantSetup: "Мгновенная Настройка", authRequired: "ТРЕБУЕТСЯ АУТЕНТИФИКАЦИЯ", authDesc: "Войдите или создайте аккаунт для продолжения аллокации.", btnLogin: "ВОЙТИ ДЛЯ ПРОДОЛЖЕНИЯ", btnRegister: "СОЗДАТЬ АККАУНТ", confirmDeployment: "Подтвердить Развёртывание", deploymentDesc: "Подтверждая, вы разрешаете развёртывание алгоритмической инфраструктуры плана {{plan}}.", proceedPayment: "ПЕРЕЙТИ К БЕЗОПАСНОЙ ОПЛАТЕ", secureGateway: "Безопасный Шлюз", back: "Назад", riskDisclosure: "Раскрытие Рисков: Алгоритмическая торговля сопряжена со значительным риском убытков. Прошлые результаты не гарантируют будущих.", secureTransaction: "Безопасная Транзакция", paypalNote: "Платёжная информация обрабатывается безопасно через PayPal. Braxel Markets не хранит данные вашей карты.", encryptionNote: "Зашифровано по Институциональным Стандартам AES-256", verifying: "Верификация Институциональной Транзакции...", loading: "Загрузка Терминала...", globalInfra: "Глобальная Платёжная Инфраструктура", qrCode: "QR-Код", allCards: "Все Карты", selectPaymentMethod: "Выбрать Способ Оплаты", choosePayment: "Выберите способ оплаты", creditCard: "Кредитная Карта", instantPayment: "Мгновенная оплата", cardDesc: "Visa, Mastercard и другие карты", crypto: "Криптовалюта", cryptoLabel: "USDT, BTC, ETH", cryptoDesc: "Быстрый и безопасный крипто-перевод", securePayment: "Безопасная Оплата", cardNumber: "Номер Карты", cardName: "Имя на Карте", cardExpiry: "Срок Действия", payNow: "ОПЛАТИТЬ СЕЙЧАС", amountToPay: "Сумма к Оплате", selectNetwork: "Выбрать Сеть", yourAddress: "Ваш Адрес", yourAddressPlaceholder: "Введите ваш адрес USDT", important: "ВАЖНО", cryptoNote: "Отправьте точную сумму для получения плана", confirmCrypto: "ПОДТВЕРДИТЬ КРИПТО", copied: "Скопировано!", cryptoPending: "Оплата зарегистрирована! Ожидание подтверждения.", processing: "Обработка...", paymentSuccess: "Оплата одобрена!", selectCountry: "Выбрать Страну", searchCountry: "Поиск страны...", phone: "Номер Телефона", fillAllFields: "Заполните все поля", phonePlaceholder: "999999999", cardNumberPlaceholder: "0000 0000 0000 0000", cardNamePlaceholder: "ПОЛНОЕ ИМЯ", cardExpiryPlaceholder: "ММ/ГГ", cvvPlaceholder: "123", cvvLabel: "CVC", paymentFailed: "Оплата не удалась", paymentError: "Ошибка оплаты" },
...
const zhTranslation = {
  ...
  auth: { loginTitle: "登录", loginSubtitle: "请输入您的访问凭证。", registerTitle: "创建账户", registerSubtitle: "开启您的机构市场之旅。", email: "电子邮箱", password: "密码", fullName: "全名", forgotPassword: "忘记密码？", noAccount: "还没有账户？", hasAccount: "已有访问权限？", btnAccess: "访问账户", btnCreate: "创建我的账户", termsAgree: "我同意条款和隐私政策。", futureTitle: "投资的", futureSubtitle: "未来", features: ["机构级算法", "高级资本保护", "毫秒级执行", "完全透明"], accessBadge: "机构访问", emailPlaceholder: "输入您的电子邮箱", fullNamePlaceholder: "输入您的全名", loginLink: "登录", loginSideDescription: "访问您的机构终端。", loginSideFooter: "机构级安全性", loginErrorMessage: "无效的凭证。请重试。", registerErrorMessage: "注册失败。请重试。", registerSuccessMessage: "账户创建成功！", registerSideFooter: "受机构级安全保护", welcomeBackTitle: "欢迎回来", welcomeBackHighlight: "机构终端", accountNotFound: "未找到账户。请先创建账户。", rememberMe: "记住我", registerLink: "创建账户", passwordPlaceholder: "密码" },
  ...
  plans: {
    starter: "初学者 2K",
    starterFeatures: "自动化、账户管理、邮件支持、风险控制",
    pro: "专业 5K",
    proFeatures: "初学者功能、优先支持、详细日志",
    advanced: "高级 25K",
...
const jaTranslation = {
  ...
  auth: { loginTitle: "ログイン", loginSubtitle: "アクセス認証情報を入力してください。", registerTitle: "アカウント作成", registerSubtitle: "機関市場での旅を始めましょう。", email: "メールアドレス", password: "パスワード", fullName: "氏名", forgotPassword: "パスワードをお忘れですか？", noAccount: "アカウントをお持ちでないですか？", hasAccount: "既にアクセス権をお持ちですか？", btnAccess: "アカウントにアクセス", btnCreate: "アカウントを作成", termsAgree: "利用規約とプライバシーポリシーに同意します。", futureTitle: "投資の", futureSubtitle: "未来", features: ["機関投資家レベルのアルゴリズム", "高度な資本保護", "ミリ秒単位の約定", "完全な透明性"], accessBadge: "機関アクセス", emailPlaceholder: "メールアドレスを入力", fullNamePlaceholder: "氏名を入力", loginLink: "ログイン", loginSideDescription: "機関ターミナルにアクセス。", loginSideFooter: "機関レベルのセキュリティ", loginErrorMessage: "認証情報が無効です。再試行してください。", registerErrorMessage: "登録に失敗しました。再試行してください。", registerSuccessMessage: "アカウントが正常に作成されました！", registerSideFooter: "機関レベルのセキュリティで保護", welcomeBackTitle: "おかえりなさい", welcomeBackHighlight: "機関ターミナル", accountNotFound: "アカウントが見つかりません。まずアカウントを作成してください。", rememberMe: "ログイン状態を保持", registerLink: "アカウント作成", passwordPlaceholder: "パスワード" },
  ...
  plans: {
    starter: "スターター 2K",
    starterFeatures: "自動化、口座管理、メールサポート、リスク管理",
    pro: "プロ 5K",
    proFeatures: "スターター機能、優先サポート、詳細ログ",
    advanced: "アドバンス 25K",
...
const arTranslation = {
  ...
  auth: { loginTitle: "تسجيل الدخول", loginSubtitle: "أدخل بيانات الوصول الخاصة بك.", registerTitle: "إنشاء حساب", registerSubtitle: "ابدأ رحلتك في السوق المؤسسي.", email: "البريد الإلكتروني", password: "كلمة المرور", fullName: "الاسم الكامل", forgotPassword: "نسيت كلمة المرور؟", noAccount: "ليس لديك حساب؟", hasAccount: "لديك وصول بالفعل؟", btnAccess: "الوصول إلى الحساب", btnCreate: "إنشاء حسابي", termsAgree: "أوافق على الشروط والخصوصية.", futureTitle: "مستقبل", futureSubtitle: "الاستثمار", features: ["خوارزميات مؤسسية", "حماية رأس المال المتقدمة", "تنفيذ بالميلي ثانية", "شفافية كاملة"], loginLink: "تسجيل الدخول", loginSideDescription: "الوصول إلى محطة الإدارة المؤسسية.", loginSideFooter: "أمان على المستوى المؤسسي", loginErrorMessage: "بيانات الاعتماد غير صالحة. يرجى المحاولة مرة أخرى.", registerErrorMessage: "فشل التسجيل. يرجى المحاولة مرة أخرى.", registerSuccessMessage: "تم إنشاء الحساب بنجاح!", registerSideFooter: "محمي بأمان مؤسسي", welcomeBackTitle: "مرحبا بعودتك", welcomeBackHighlight: "المحطة المؤسسية", accountNotFound: "الحساب غير موجود. يرجى إنشاء حساب أولا.", rememberMe: "تذكرني", registerLink: "إنشاء حساب" },
  ...
  plans: {
    starter: "ستارتر 2K",
    starterFeatures: "أتمتة، إدارة الحساب، دعم البريد الإلكتروني، مخاطر محكومة",
    pro: "برو 5K",
    proFeatures: "ميزات ستارتر، دعم أولوي، سجلات مفصلة",
    advanced: "متقدم 25K",
...
const heTranslation = {
  ...
  plans: {
    starter: "סטרטר 2K",
    starterFeatures: "אוטומציה, ניהול חשבון, תמיכה באימייל, סיכון מבוקר",
    pro: "פרו 5K",
    proFeatures: "תכונות סטרטר, תמיכה בעדיפות, לוגים מפורטים",
    advanced: "מתקדם 25K",
