...
const enTranslation = {
  ...
  pricing: { badge: "TRANSPARENCY", title: "CAPITAL", subtitle: "ALLOCATIONS", desc: "Institutional-grade infrastructure with a transparent fee structure.", select: "SECURE THIS PLAN", allocation: "MANAGED CAPITAL", month: "monthly fee", detectedCurrency: "Prices shown in your local currency ({{currency}}) based on your location" },
  plans: {
    starter: "STARTER 2K",
...
const ptTranslation = {
  ...
  pricing: { badge: "TRANSPARÊNCIA", title: "ALOCAÇÃO", subtitle: "DE CAPITAL", desc: "Infraestrutura de nível institucional com uma estrutura de taxas transparente.", select: "GARANTIR ESTE PLANO", allocation: "CAPITAL GERENCIADO", month: "taxa mensal", detectedCurrency: "Preços exibidos na sua moeda local ({{currency}}) com base na sua localização" },
  plans: {
    starter: "STARTER 2K",
...
const itTranslation = {
  ...
  pricing: { badge: "TRASPARENZA", title: "ALLOCAZIONI DI", subtitle: "CAPITALE", desc: "Infrastruttura di livello istituzionale con una struttura tariffaria trasparente.", select: "GARANTISCI QUESTO PIANO", allocation: "CAPITALE GESTITO", month: "tariffa mensile", detectedCurrency: "Prezzi mostrati nella tua valuta locale ({{currency}}) in base alla tua posizione" },
  plans: {
    starter: "STARTER 2K",
...
const esTranslation = {
  ...
  pricing: { badge: "TRANSPARENCIA", title: "ASIGNACIONES DE", subtitle: "CAPITAL", desc: "Infraestructura de nivel institucional con una estructura de tarifas transparente.", select: "ASEGURAR ESTE PLAN", allocation: "CAPITAL GESTIONADO", month: "tarifa mensual", detectedCurrency: "Precios mostrados en tu moneda local ({{currency}}) según tu ubicación" },
  plans: {
    starter: "STARTER 2K",
...
const frTranslation = {
  ...
  pricing: { badge: "TRANSPARENCE", title: "ALLOCATIONS DE", subtitle: "CAPITAL", desc: "Infrastructure de niveau institutionnel avec une structure tarifaire transparente.", select: "SÉCURISER CE PLAN", allocation: "CAPITAL GÉRÉ", month: "frais mensuels", detectedCurrency: "Prix affichés dans votre devise locale ({{currency}}) selon votre emplacement" },
  plans: {
    starter: "STARTER 2K",
...
const deTranslation = {
  ...
  pricing: { badge: "TRANSPARENZ", title: "KAPITAL-", subtitle: "ALLOKATIONEN", desc: "Institutionelle Infrastruktur mit transparenter Gebührenstruktur.", select: "DIESEN PLAN SICHERN", allocation: "VERWALTETES KAPITAL", month: "monatliche Gebühr", detectedCurrency: "Preise in Ihrer lokalen Währung ({{currency}}) basierend auf Ihrem Standort" },
  plans: {
    starter: "STARTER 2K",
...
const ruTranslation = {
  ...
  pricing: { badge: "ПРОЗРАЧНОСТЬ", title: "АЛЛОКАЦИИ", subtitle: "КАПИТАЛА", desc: "Институциональная инфраструктура с прозрачной структурой комиссий.", select: "ВЫБРАТЬ ЭТОТ ПЛАН", allocation: "УПРАВЛЯЕМЫЙ КАПИТАЛ", month: "ежемесячная плата", detectedCurrency: "Цены показаны в местной валюте ({{currency}}) на основе вашего местоположения" },
  plans: {
    starter: "СТАРТЕР 2K",
...
const zhTranslation = {
  ...
  pricing: { badge: "透明度", title: "资本", subtitle: "配置", desc: "机构级基础设施，透明费率结构。", select: "选择此计划", allocation: "管理资本", month: "月费", detectedCurrency: "根据您的位置以当地货币（{{currency}}）显示价格" },
  plans: {
    starter: "初学者 2K",
...
const jaTranslation = {
  ...
  pricing: { badge: "透明性", title: "資本", subtitle: "配分", desc: "透明な手数料体系の機関投資家レベルインフラ。", select: "このプランを確保", allocation: "運用資本", month: "月額料金", detectedCurrency: "お客様の所在地に基づいて当地通貨（{{currency}}）で価格を表示" },
  plans: {
    starter: "スターター 2K",
...
// Arabic translations
const arTranslation = {
  nav: { pricing: "خطط الاستثمار", howItWorks: "البنية التحتية", about: "من نحن", contact: "الدعم المؤسسي", login: "الوصول إلى المحطة", support: "الدعم", openAccount: "إنشاء حساب", dashboard: "لوحة التحكم", logout: "تسجيل الخروج" },
  ...
  pricing: { badge: "الشفافية", title: "تخصيصات", subtitle: "رأس المال", desc: "بنية تحتية مؤسسية بهيكل رسوم شفاف.", select: "احصل على هذا الخطة", allocation: "رأس المال المُدار", month: "رسوم شهرية", detectedCurrency: "الأسعار معروضة بعملتك المحلية ({{currency}}) بناءً على موقعك" },
  plans: {
    starter: "ستارتر 2K",
...
const heTranslation = {
  ...
  pricing: { badge: "שקיפות", title: "הקצאות", subtitle: "הון", desc: "תשתית ברמה מוסדית עם מבנה עמלות שקוף.", select: "הבטח תוכנית זו", allocation: "הון מנוהל", month: "עמלה חודשית", detectedCurrency: "מחירים מוצגים במטבע המקומי שלך ({{currency}}) בהתבסס על מיקומך" },
  plans: {
    starter: "סטרטר 2K",
