...
const enTranslation = {
  ...
  auth: { loginTitle: "Login", loginSubtitle: "Enter your access credentials.", registerTitle: "Create Account", registerSubtitle: "Start your journey in the institutional market.", email: "Email Address", password: "Password", fullName: "Full Name", forgotPassword: "Forgot password?", noAccount: "Don't have an account?", hasAccount: "Already have access?", btnAccess: "ACCESS ACCOUNT", btnCreate: "CREATE MY ACCOUNT", termsAgree: "I agree to the Terms and Privacy.", futureTitle: "The Future of", futureSubtitle: "Investment", features: ["Institutional-grade algorithms", "Advanced capital protection", "Millisecond execution", "Total transparency"], securityBadge: "Security", accessBadge: "Access", createAccountLink: "Create account", loginLink: "Login", welcomeBackTitle: "Welcome", welcomeBackHighlight: "Back", loginSideDescription: "Access your investment infrastructure and monitor your performance in real-time.", registerSideFooter: "Institutional Infrastructure.", loginSideFooter: "Secure Access.", fullNamePlaceholder: "Your name", emailPlaceholder: "email@example.com", loginSuccessMessage: "Login successful!", loginErrorMessage: "Error logging in.", registerSuccessMessage: "Account created! Please check your email to confirm.", registerErrorMessage: "Error creating account." },
...
const ptTranslation = {
  ...
  auth: { loginTitle: "Login", loginSubtitle: "Insira suas credenciais de acesso.", registerTitle: "Criar Conta", registerSubtitle: "Comece sua jornada no mercado institucional.", email: "Endereço de E-mail", password: "Senha", fullName: "Nome Completo", forgotPassword: "Esqueceu a senha?", noAccount: "Não tem uma conta?", hasAccount: "Já possui acesso?", btnAccess: "ACESSAR CONTA", btnCreate: "CRIAR MINHA CONTA", termsAgree: "Eu concordo com os Termos e Privacidade.", futureTitle: "O Futuro do", futureSubtitle: "Investimento", features: ["Algoritmos institucionais", "Proteção de capital avançada", "Execução em milissegundos", "Transparência total"], securityBadge: "Segurança", accessBadge: "Acesso", createAccountLink: "Criar conta", loginLink: "Login", welcomeBackTitle: "Bem-vindo", welcomeBackHighlight: "de volta", loginSideDescription: "Acesse sua infraestrutura de investimento e monitore seu desempenho em tempo real.", registerSideFooter: "Infraestrutura Institucional.", loginSideFooter: "Acesso Seguro.", fullNamePlaceholder: "Seu nome", emailPlaceholder: "email@exemplo.com", loginSuccessMessage: "Login realizado com sucesso!", loginErrorMessage: "Erro ao fazer login.", registerSuccessMessage: "Conta criada! Verifique seu e-mail para confirmar.", registerErrorMessage: "Erro ao criar conta." },
  ...
  methodology: { badge: "METODOLOGIA", title: "ESTRATÉGIAS QUANTITATIVAS", momentum: { title: "ANÁLISE DE MOMENTUM", desc: "Identificação de tendências de alta probabilidade usando redes neurais proprietárias.", f1: "Detecção de Tendência", f2: "Análise de Volume", f3: "Reconhecimento de Padrões" }, volatility: { title: "ADAPTAÇÃO DE VOLATILIDADE", desc: "Ajuste dinâmico de exposição baseado em condições de mercado em tempo real.", f1: "Hedge Dinâmico", f2: "Stops Adaptativos", f3: "Monitoramento de Liquidez" }, risk: { title: "MITIGAÇÃO DE RISCO", desc: "Protocolos de proteção em múltiplas camadas para garantir a preservação do capital.", f1: "Controle de Drawdown", f2: "Correlação de Ativos", f3: "Testes de Estresse" } },
