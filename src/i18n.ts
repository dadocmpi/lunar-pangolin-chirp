...
const ptTranslation = {
  ...
  nav: { pricing: "PLANOS DE INVESTIMENTO", howItWorks: "INFRAESTRUTURA", about: "SOBRE NÓS", contact: "SUPORTE INSTITUCIONAL", login: "ACESSO AO TERMINAL", support: "Suporte", openAccount: "CRIAR CONTA", dashboard: "PAINEL", logout: "SAIR", selectLanguage: "Selecionar Idioma" },
...
const itTranslation = {
  ...
  nav: { pricing: "PIANI DI INVESTIMENTO", howItWorks: "INFRASTRUTTURA", about: "CHI SIAMO", contact: "SUPPORTO ISTITUZIONALE", login: "ACCESSO TERMINALE", support: "Supporto", openAccount: "CREA ACCOUNT", dashboard: "PANNELLO", logout: "ESCI", selectLanguage: "Seleziona Lingua" },
...
const esTranslation = {
  ...
  nav: { pricing: "PLANES DE INVERSIÓN", howItWorks: "INFRAESTRUCTURA", about: "SOBRE NOSOTROS", contact: "SOPORTE INSTITUCIONAL", login: "ACCESO AL TERMINAL", support: "Soporte", openAccount: "CREAR CUENTA", dashboard: "PANEL", logout: "CERRAR SESIÓN", selectLanguage: "Seleccionar Idioma" },
...
const frTranslation = {
  ...
  nav: { pricing: "PLANS D'INVESTISSEMENT", howItWorks: "INFRASTRUCTURE", about: "À PROPOS", contact: "SUPPORT INSTITUTIONNEL", login: "ACCÈS TERMINAL", support: "Support", openAccount: "CRÉER UN COMPTE", dashboard: "TABLEAU DE BORD", logout: "DÉCONNEXION", selectLanguage: "Sélectionner la Langue" },
  ...
  auth: { loginTitle: "Connexion", loginSubtitle: "Entrez vos identifiants d'accès.", registerTitle: "Créer un Compte", registerSubtitle: "Commencez votre parcours sur le marché institutionnel.", email: "Adresse E-mail", password: "Mot de Passe", fullName: "Nom Complet", forgotPassword: "Mot de passe oublié ?", noAccount: "Vous n'avez pas de compte ?", hasAccount: "Vous avez déjà accès ?", btnAccess: "ACCÉDER AU COMPTE", btnCreate: "CRÉER MON COMPTE", termsAgree: "J'accepte les Conditions et la Confidentialité.", futureTitle: "L'Avenir de", futureSubtitle: "l'Investissement", features: ["Algorithmes de niveau institutionnel", "Protection avancée du capital", "Exécution en millisecondes", "Transparence totale"], accessBadge: "Accès Institutionnel", emailPlaceholder: "Entrez votre e-mail", fullNamePlaceholder: "Entrez votre nom complet", loginLink: "Connexion", loginSideDescription: "Accédez à votre terminal institutionnel.", loginSideFooter: "Sécurité de niveau institutionnel", loginErrorMessage: "Identifiants invalides. Veuillez réessayer.", registerErrorMessage: "Échec de l'inscription. Veuillez réessayer.", registerSuccessMessage: "Compte créé avec succès !", registerSideFooter: "Protégé par sécurité institutionnelle", welcomeBackTitle: "Bienvenue", welcomeBackHighlight: "Terminal Institutionnel", accountNotFound: "Compte introuvable. Veuillez d'abord créer un compte.", rememberMe: "Se souvenir de moi", registerLink: "Créer un compte", passwordPlaceholder: "Entrez votre mot de passe" },
...
const deTranslation = {
  ...
  nav: { pricing: "INVESTMENTPLÄNE", howItWorks: "INFRASTRUKTUR", about: "ÜBER UNS", contact: "INSTITUTIONELLER SUPPORT", login: "TERMINAL-ZUGANG", support: "Support", openAccount: "KONTO ERSTELLEN", dashboard: "DASHBOARD", logout: "ABMELDEN", selectLanguage: "Sprache Auswählen" },
...
const ruTranslation = {
  ...
  nav: { pricing: "ИНВЕСТИЦИОННЫЕ ПЛАНЫ", howItWorks: "ИНФРАСТРУКТУРА", about: "О НАС", contact: "ИНСТИТУЦИОНАЛЬНАЯ ПОДДЕРЖКА", login: "ДОСТУП К ТЕРМИНАЛУ", support: "Поддержка", openAccount: "СОЗДАТЬ АККАУНТ", dashboard: "ПАНЕЛЬ УПРАВЛЕНИЯ", logout: "ВЫХОД", selectLanguage: "Выбрать Язык" },
  ...
  auth: { loginTitle: "Вход", loginSubtitle: "Введите ваши учётные данные.", registerTitle: "Создать Аккаунт", registerSubtitle: "Начните свой путь на институциональном рынке.", email: "Электронная Почта", password: "Пароль", fullName: "Полное Имя", forgotPassword: "Забыли пароль?", noAccount: "Нет аккаунта?", hasAccount: "Уже есть доступ?", btnAccess: "ВОЙТИ В АККАУНТ", btnCreate: "СОЗДАТЬ АККАУНТ", termsAgree: "Я принимаю Условия и Политику конфиденциальности.", futureTitle: "Будущее", futureSubtitle: "Инвестиций", features: ["Алгоритмы институционального уровня", "Продвинутая защита капитала", "Исполнение в миллисекундах", "Полная прозрачность"], accessBadge: "Институциональный Доступ", emailPlaceholder: "Введите вашу почту", fullNamePlaceholder: "Введите ваше полное имя", loginLink: "Войти", loginSideDescription: "Доступ к вашему институциональному терминалу.", loginSideFooter: "Безопасность институционального уровня", loginErrorMessage: "Неверные учётные данные. Попробуйте снова.", registerErrorMessage: "Ошибка регистрации. Попробуйте снова.", registerSuccessMessage: "Аккаунт успешно создан!", registerSideFooter: "Защищено институциональной безопасностью", welcomeBackTitle: "С Возвращением", welcomeBackHighlight: "Институциональный Терминал", accountNotFound: "Аккаунт не найден. Пожалуйста, сначала создайте аккаунт.", rememberMe: "Запомнить меня", registerLink: "Создать аккаунт", passwordPlaceholder: "Введите пароль" },
...
const zhTranslation = {
  ...
  nav: { pricing: "投资计划", howItWorks: "基础设施", about: "关于我们", contact: "机构支持", login: "终端访问", support: "支持", openAccount: "创建账户", dashboard: "控制面板", logout: "退出登录", selectLanguage: "选择语言" },
  ...
  auth: { loginTitle: "登录", loginSubtitle: "请输入您的访问凭证。", registerTitle: "创建账户", registerSubtitle: "开启您的机构市场之旅。", email: "电子邮箱", password: "密码", fullName: "全名", forgotPassword: "忘记密码？", noAccount: "还没有账户？", hasAccount: "已有访问权限？", btnAccess: "访问账户", btnCreate: "创建我的账户", termsAgree: "我同意条款和隐私政策。", futureTitle: "投资的", futureSubtitle: "未来", features: ["机构级算法", "高级资本保护", "毫秒级执行", "完全透明"], accessBadge: "机构访问", emailPlaceholder: "请输入您的邮箱", fullNamePlaceholder: "请输入您的全名", loginLink: "登录", loginSideDescription: "访问您的机构终端。", loginSideFooter: "机构级安全性", loginErrorMessage: "凭证无效，请重试。", registerErrorMessage: "注册失败，请重试。", registerSuccessMessage: "账户创建成功！", registerSideFooter: "受机构安全保护", welcomeBackTitle: "欢迎回来", welcomeBackHighlight: "机构终端", accountNotFound: "未找到账户，请先创建账户。", rememberMe: "记住我", registerLink: "创建账户", passwordPlaceholder: "请输入密码" },
...
const jaTranslation = {
  ...
  nav: { pricing: "投資プラン", howItWorks: "インフラストラクチャ", about: "会社概要", contact: "機関サポート", login: "ターミナルアクセス", support: "サポート", openAccount: "アカウント作成", dashboard: "ダッシュボード", logout: "ログアウト", selectLanguage: "言語を選択" },
