...
const esTranslation = {
  ...
  dashboard: { portfolio: "Portafolio", activeServices: "Servicios Activos", newAllocation: "Nueva Asignación", noServices: "No se encontraron planes de inversión activos.", balance: "Saldo Actual", withdraw: "Retiro", liquidity: "Liquidez", requestWithdraw: "Solicitar Retiro", selectAccount: "Seleccionar Cuenta", amount: "Monto (USD)", iban: "IBAN / Datos Bancarios", btnWithdraw: "ENVIAR SOLICITUD DE RETIRO", profile: "Gestión de Perfil", settings: "Configuración", firstName: "Nombre", lastName: "Apellido", saveChanges: "GUARDAR CAMBIOS", verifiedAccount: "Cuenta Verificada", totalAUM: "Total de Activos en Gestión", activeAlgos: "Algoritmos Activos", systemStatus: "Estado del Sistema", operational: "Operativo", infraProtection: "Protección de Infraestructura", twoFactor: "Autenticación de Dos Factores", notEnabled: "No Activada", enable2FA: "Activar 2FA", kycStatus: "Verificación KYC", verified: "Verificado", viewDocs: "Ver Documentos", investor: "Inversor"  , kycRequired: "", kycRequiredDesc: "", kycUnderReview: "", kycUnderReviewDesc: "", kycRejected: "", kycRejectedDesc: "", resubmitDocs: "", completeVerification: "", verificationRequired: "", goToVerification: "", totalProfit: "", drawdown: "", maxDrawdown: "", assetsInOperation: "", monthlyReturns: "", analytics: "", newWithdrawalRequest: "", walletIban: "", network: "", transactionHistory: "", operations: "", asset: "", type: "", entry: "", exit: "", profit: "", time: "", status: "", open: "", closed: "", accountNotFound: "", loginSuccess: "", rememberMe: "" },
