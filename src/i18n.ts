...
const frTranslation = {
  ...
  auth: { loginTitle: "Connexion", loginSubtitle: "Entrez vos identifiants d'accès.", registerTitle: "Créer un Compte", registerSubtitle: "Commencez votre parcours sur le marché institutionnel.", email: "Adresse E-mail", password: "Mot de Passe", fullName: "Nom Complet", forgotPassword: "Mot de passe oublié ?", noAccount: "Vous n'avez pas de compte ?", hasAccount: "Vous avez déjà accès ?", btnAccess: "ACCÉDER AU COMPTE", btnCreate: "CRÉER MON COMPTE", termsAgree: "J'accepte les Conditions et la Confidentialité.", futureTitle: "L'Avenir de", futureSubtitle: "l'Investissement", features: ["Algorithmes de niveau institutionnel", "Protection avancée du capital", "Exécution en millisecondes", "Transparence totale"], accessBadge: "Accès Institutionnel", emailPlaceholder: "Entrez votre email", fullNamePlaceholder: "Entrez votre nom complet", loginLink: "Se connecter", loginSideDescription: "Accédez à votre terminal institutionnel.", loginSideFooter: "Sécurité de Niveau Institutionnel", loginErrorMessage: "Identifiants invalides. Veuillez réessayer.", registerErrorMessage: "Échec de l'inscription. Veuillez réessayer.", registerSuccessMessage: "Compte créé avec succès !", registerSideFooter: "Protégé par sécurité institutionnelle", welcomeBackTitle: "Bon Retour", welcomeBackHighlight: "Terminal Institutionnel", accountNotFound: "Compte non trouvé. Veuillez d'abord créer un compte.", rememberMe: "Se souvenir de moi", registerLink: "Créer un compte", passwordPlaceholder: "Mot de passe" },
...
const zhTranslation = {
  ...
  auth: { loginTitle: "登录", loginSubtitle: "请输入您的访问凭证。", registerTitle: "创建账户", registerSubtitle: "开启您的机构市场之旅。", email: "电子邮箱", password: "密码", fullName: "全名", forgotPassword: "忘记密码？", noAccount: "还没有账户？", hasAccount: "已有访问权限？", btnAccess: "访问账户", btnCreate: "创建我的账户", termsAgree: "我同意条款和隐私政策。", futureTitle: "投资的", futureSubtitle: "未来", features: ["机构级算法", "高级资本保护", "毫秒级执行", "完全透明"], accessBadge: "机构访问", emailPlaceholder: "输入您的邮箱", fullNamePlaceholder: "输入您的全名", loginLink: "登录", loginSideDescription: "访问您的机构终端。", loginSideFooter: "机构级安全保障", loginErrorMessage: "凭证无效，请重试。", registerErrorMessage: "注册失败，请重试。", registerSuccessMessage: "账户创建成功！", registerSideFooter: "受机构安全保障", welcomeBackTitle: "欢迎回来", welcomeBackHighlight: "机构终端", accountNotFound: "未找到账户，请先创建账户。", rememberMe: "记住我", registerLink: "创建账户", passwordPlaceholder: "密码" },
...
const jaTranslation = {
  ...
  auth: { loginTitle: "ログイン", loginSubtitle: "アクセス認証情報を入力してください。", registerTitle: "アカウント作成", registerSubtitle: "機関市場での旅を始めましょう。", email: "メールアドレス", password: "パスワード", fullName: "氏名", forgotPassword: "パスワードをお忘れですか？", noAccount: "アカウントをお持ちでないですか？", hasAccount: "既にアクセス権をお持ちですか？", btnAccess: "アカウントにアクセス", btnCreate: "アカウントを作成", termsAgree: "利用規約とプライバシーポリシーに同意します。", futureTitle: "投資の", futureSubtitle: "未来", features: ["機関投資家レベルのアルゴリズム", "高度な資本保護", "ミリ秒単位の約定", "完全な透明性"], accessBadge: "機関アクセス", emailPlaceholder: "メールアドレスを入力", fullNamePlaceholder: "氏名を入力", loginLink: "ログイン", loginSideDescription: "機関ターミナルにアクセス。", loginSideFooter: "機関グレードのセキュリティ", loginErrorMessage: "認証情報が無効です。再試行してください。", registerErrorMessage: "登録に失敗しました。再試行してください。", registerSuccessMessage: "アカウントが正常に作成されました！", registerSideFooter: "機関グレードのセキュリティで保護", welcomeBackTitle: "おかえりなさい", welcomeBackHighlight: "機関ターミナル", accountNotFound: "アカウントが見つかりません。まずアカウントを作成してください。", rememberMe: "ログイン情報を保存", registerLink: "アカウント作成", passwordPlaceholder: "パスワード" },
