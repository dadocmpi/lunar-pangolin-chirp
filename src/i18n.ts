...
const enTranslation = {
  nav: { pricing: "INVESTMENT PLANS", howItWorks: "THE INFRASTRUCTURE", about: "ABOUT US", contact: "INSTITUTIONAL SUPPORT", login: "TERMINAL ACCESS", support: "Support", openAccount: "CREATE ACCOUNT", dashboard: "DASHBOARD", logout: "SIGN OUT" },
  footer: { desc: "Institutional-grade investment infrastructure. Proprietary technology for the modern market.", platform: "Platform", company: "Company", support: "Digital Support", rights: "All rights reserved.", privacy: "Privacy", terms: "Terms", disclaimer: "Financial Disclaimer", address: "Commercial Address", addressValue: "Av. Paulista, 1374 - Bela Vista, São Paulo - SP, 01310-100, Brazil", riskTitle: "RISK DISCLAIMER", riskText: "Trading", chatbot: { title: "Braxel Support", placeholder: "Type a message...", emailSupport: "Email:" }
  ...
  dashboard: { 
    ...
    kycRequiredDesc: "Complete identity verification to access all platform features. This is mandatory for all accounts managing capital.",
    kycUnderReview: "KYC Under Review",
    kycUnderReviewDesc: "Your documents are being reviewed by our compliance team. This usually takes 24-48 hours.",
...
const frTranslation = {
  ...
  footer: { desc: "Infrastructure d'investissement de niveau institutionnel. Technologie propriétaire pour le marché moderne.", platform: "Plateforme", company: "Entreprise", support: "Support Digital", rights: "Tous droits réservés.", privacy: "Confidentialité", terms: "Conditions", disclaimer: "Avertissement Financier", address: "Adresse Commerciale", addressValue: "Av. Paulista, 1374 - Bela Vista, São Paulo - SP, 01310-100, Brésil", riskTitle: "AVERTISSEMENT SUR LES RISQUES", riskText: "Le trading", chatbot: { title: "Support Braxel", placeholder: "Tapez un message...", emailSupport: "Email:" }
...
const ruTranslation = {
  ...
  footer: { desc: "Инвестиционная инфраструктура институционального уровня. Проприетарная технология для современного рынка.", platform: "Платформа", company: "Компания", support: "Цифровая Поддержка", rights: "Все права защищены.", privacy: "Конфиденциальность", terms: "Условия", disclaimer: "Финансовое Уведомление", address: "Коммерческий Адрес", addressValue: "Av. Paulista, 1374 - Bela Vista, São Paulo - SP, 01310-100, Бразилия", riskTitle: "ПРЕДУПРЕЖДЕНИЕ О РИСКАХ", riskText: "Торговля", chatbot: { title: "Поддержка Braxel", placeholder: "Введите сообщение...", emailSupport: "Email:" }
...
const arTranslation = {
  ...
  footer: { desc: "بنية تحتية استثمارية مؤسسية. تقنية مملوكة للسوق الحديث.", platform: "المنصة", company: "الشركة", support: "الدعم الرقمي", rights: "جميع الحقوق محفوظة.", privacy: "الخصوصية", terms: "الشروط", disclaimer: "إخلاء المسؤولية المالية", address: "العنوان التجاري", addressValue: "Av. Paulista, 1374 - Bela Vista, São Paulo - SP, 01310-100, البرازيل", riskTitle: "إخلاء مسؤولية المخاطر", riskText: "التداول", chatbot: { title: "دعم Braxel", placeholder: "اكتب رسالة...", emailSupport: "البريد الإلكتروني:" }
