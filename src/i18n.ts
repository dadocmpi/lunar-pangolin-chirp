...
// Arabic translations
const arTranslation = {
  nav: { pricing: "خطط الاستثمار", howItWorks: "البنية التحتية", about: "من نحن", contact: "الدعم المؤسسي", login: "الوصول إلى المحطة", support: "الدعم", openAccount: "إنشاء حساب", dashboard: "لوحة التحكم", logout: "تسجيل الخروج", selectLanguage: "Select Language" },
...
// Hebrew translations
const heTranslation = {
  nav: { pricing: "תוכניות השקעה", howItWorks: "תשתית", about: "אודות", contact: "תמיכה מוסדית", login: "גישה לטרמינל", support: "תמיכה", openAccount: "יצירת חשבון", dashboard: "לוח בקרה", logout: "התנתקות", selectLanguage: "Select Language" },
