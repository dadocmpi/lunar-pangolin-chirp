...
const countries = [
  ...
  { code: 'KE' : name: 'Kenya', name_pt: 'Quênia', name_es: 'Kenia', name_it: 'Kenya', name_fr: 'Kenya', name_de: 'Kenia', name_ru: 'Кения', name_ja: 'ケニア', name_ar: 'كينيا', name_he: 'קניה', ddi: '+254', flag: '🇰🇪' },
