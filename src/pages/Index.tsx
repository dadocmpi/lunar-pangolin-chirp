    ...
    <div className="min-h-screen bg-black font-sans text-white selection:bg-[#D4AF37] selection:text-black">
      ...
      <section className="relative mt-[110px] min-h-[85vh] flex items-center justify-center overflow-hidden bg-[linear-gradient(135deg,#000000_0%,#0a0e27_100%)]">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-fadeInUp">
          ...
          <h1 className="font-serif text-[48px] md:text-[86px] font-bold leading-[1.05] mb-8 tracking-[-0.04em] text-white uppercase">
            {t('hero.title1')}
            <span className="block text-[#D4AF37] mt-2">{t('hero.title2')}</span>
          </h1>
          
          <p className="font-sans text-[15px] md:text-[19px] text-slate-400 mb-12 leading-[1.7] max-w-[720px] mx-auto font-medium">
            {t('hero.desc')}
          </p>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16">
          {stats.map((stat, i) => (
            <div key={i} className="text-center group">
              <div className="font-serif text-[42px] md:text-[56px] font-bold text-white mb-3 tracking-[-0.02em] group-hover:text-[#D4AF37] transition-colors duration-500">
                {stat.value}
              </div>
      ...
      <section className="py-32 px-8 bg-[#05070A]">
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-24 text-center">
            ...
            <h2 className="text-[36px] md:text-[52px] font-serif font-bold uppercase tracking-tight leading-tight">{t('methodology.title')}</h2>
          </div>
      ...
      <section className="py-32 px-8 bg-[#05070A] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-24 text-center">
            ...
            <h2 className="text-[36px] md:text-[52px] font-serif font-bold uppercase tracking-tight">
      ...
      <section className="py-40 px-8 relative overflow-hidden border-t border-white/5">
        ...
        <div className="max-w-[1000px] mx-auto text-center relative z-10">
          ...
          <h2 className="font-serif text-[48px] md:text-[72px] font-bold leading-[1.1] mb-10 tracking-[-0.03em] uppercase">
            {t('cta_home.title')} <br />
            <span className="text-[#D4AF37]">{t('cta_home.subtitle')}</span>
          </h2>
          <p className="font-sans text-[16px] md:text-[20px] text-slate-400 mb-16 leading-[1.7] max-w-[750px] mx-auto font-medium">
            {t('cta_home.desc')}
          </p>
