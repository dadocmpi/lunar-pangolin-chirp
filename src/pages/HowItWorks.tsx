        ...
        <div className="container mx-auto px-8">
          <div className="max-w-3xl animate-fadeInUp">
            ...
            <h1 className="font-serif text-[28px] md:text-[48px] font-bold leading-[1.1] mb-6 tracking-[-0.03em] uppercase">
              ...
              <span className="text-white">{t('howItWorks.subtitle')}</span>
            </h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5 border border-white/5">
          {steps.map((step, i) => (
            <div key={i} className="p-12 bg-[#080B12] flex flex-col items-start hover:bg-white/[0.02] transition-all relative group">
              <span className="absolute top-8 right-8 text-[42px] font-serif font-black text-white/[0.03] group-hover:text-[#D4AF37]/10 transition-colors">0{i+1}</span>
